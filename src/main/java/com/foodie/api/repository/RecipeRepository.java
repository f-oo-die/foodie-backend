...
public interface RecipeRepository extends JpaRepository<Recipe, Long> {
  ...
  @Query(value = "SELECT r.id, r.title, r.preparation, r.num_of_calories, r.type_of_meal, r.calorie_status, r.count, r.thumbnail_image_url, r.main_image_url, ru.users_id, ru.favorite_recipes_id FROM recipes r, users_favorite_recipes ru WHERE ru.users_id = ?1", nativeQuery = true)
